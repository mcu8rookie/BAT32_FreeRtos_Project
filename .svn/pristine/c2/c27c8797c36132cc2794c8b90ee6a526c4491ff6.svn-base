...
//-----------------------------------------------------------------------
// No.33 pin(P50/TBIO0) output pulse
// No.34 pin(P51/TBIO1) output pulse
// period: 1000; skew: 300
//       period: |<---500--->| 
//       skew:   |<->|<--300				 
//	              _____       _____       _____
//	 TBIO0: _____|     |_____|     |_____|     |_____
//                    _____       _____       _____
//	 TBIO1: _________|     |_____|     |_____|     |_
//-----------------------------------------------------------------------
	TMB0_DoublePulseOutput(TMB_CLOCK_FCLK, 1000, 300);
	delayMS(100);
	
//-----------------------------------------------------------------------
// No.33 pin(P50/TBIO0) output PWM wave
// period: 1000; duty: 300(30%)
//       period: |<---1000--->| 
//       duty:   |<->|<--300				 
//	              ___         ___         ___
//	 TBIO0: _____|   |_______|   |_______|   |_____
//-----------------------------------------------------------------------	
	TMB0_PWM_1Period_1Duty(TMB_CLOCK_FCLK, 1000, 300);
	delayMS(100);
