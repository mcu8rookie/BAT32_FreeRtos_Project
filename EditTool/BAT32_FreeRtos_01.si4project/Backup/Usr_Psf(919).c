...
unsigned int PresComp_Flag;

unsigned char Flag_PresCompParameter;


unsigned char Delta_Pressure_Compensation(double prsu)
{   
    if((PresComp_Flag == 0)||(Flag_PresCompParameter == 0)||(Sensor1_TableY[14] == 0)||(Sensor1_TableY[14] == 0xFFFF))
    {   
	...
	{	
		...
		tmp2 = tmp1 - Sensor1_TableY[14];	// Delta pressure; Unit: 10Pa;
