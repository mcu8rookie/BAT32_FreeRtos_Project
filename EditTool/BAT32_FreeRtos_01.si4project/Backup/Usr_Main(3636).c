...
int main(int argc, char *argv[])
{
    ...
    while(1)
    {
        ...
        {		
            ...
            if(HR_Data_Cnt<2)
            {
                HR_Humi[HR_Data_Cnt] = TH_Sensor_Temperature_out;
                HR_Data_Cnt++;
                HR_Humi_Rate = 0;
            }
            else
            {
                ...
                HR_Humi[i] = TH_Sensor_Temperature_out;
            }
            ...
            if(PR_Data_Cnt<2)
            {
                PR_Pres[PR_Data_Cnt] = TH_Sensor_Temperature_out;
                PR_Data_Cnt++;
                PR_Pres_Rate = 0;
            }
            else
            {
                ...
                PR_Pres[i] = TH_Sensor_Temperature_out;
            }
            ...
            extern uint8_t HPC_HumiRate;
            extern uint8_t HPC_HoldCout;
            extern uint8_t HPC_PWM_Value;
            #endif
