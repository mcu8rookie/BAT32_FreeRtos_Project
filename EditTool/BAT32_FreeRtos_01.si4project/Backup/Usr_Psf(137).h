...
extern double Tcomp_X;
extern double Tcomp_Coe0;
extern double Tcomp_Coe1;
extern double Tcomp_Coe2;
extern double Tcomp_Coe3;
extern double Tcomp_Y;

void Usr_TComp_Polynomial_Cubic2(double nbr, double *out);
#endif
