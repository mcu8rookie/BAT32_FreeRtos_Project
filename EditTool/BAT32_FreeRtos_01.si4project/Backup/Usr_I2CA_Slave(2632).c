...
{   
        ...
        if(Usr_Md_CmdCode1==0x3608)
        {
            ...
            
            {
                ...
                if((cal_crc1 == I2CA_RX_Buff2[I2CA_RX_Cnt-1])&&(I2CA_RX_Buff2[2] == 0))
                {
                    ...
                    if(I2CA_RX_Buff2[3] == 0x18)
                    {
                        Psf_Gas_Type = PSF_GASTYPE_R32;
                    }
                    else if(I2CA_RX_Buff2[3] == 0x1C)
                    {
                        Psf_Gas_Type = PSF_GASTYPE_R454A;
                    }
                    else if(I2CA_RX_Buff2[3] == 0x19)
                    {
                        Psf_Gas_Type = PSF_GASTYPE_R454B;
                    }
                    else if(I2CA_RX_Buff2[3] == 0x1B)
                    {
                        Psf_Gas_Type = PSF_GASTYPE_R454C;
                    }
                    else if(I2CA_RX_Buff2[3] == 0x1D)
                    {
                        Psf_Gas_Type = PSF_GASTYPE_R455A;
                    }
                    else
                    {
                        Psf_Gas_Type = PSF_GASTYPE_DEFAULT;
                    }
                    
                    DF_Data[DEF_GASTYPE_INDEX] = (uint8_t)Psf_Gas_Type;
                    DF_Data[DEF_GASTYPE_INDEX+1] = (uint8_t)(Psf_Gas_Type>>8);
    ...
    {   // Master Write completely;
        ...
        {
            Init_printf("\t0x%02X, ",I2CA_RX_Buff[i]);
        }
    ...
    {   // Mater Read completely; (ReStart;)
        ...
        for(i=0;i<tmp1;i++)
        {
            Init_printf("\t0x%02X, ",I2CA_TX_Buff[i]);
        }
