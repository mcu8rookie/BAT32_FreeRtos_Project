                    ...
                    #if(defined(DEF_I2C_TYPE)&&(DEF_I2C_TYPE==DEF_I2C_TYPE_MIDEA))
                    {
                        if(Usr_Md_State == 2)
                        {
                            ...
                            else if(Usr_Md_CmdCode1 == 0xEC05)
                            {
                                ...
                                I2CA_TX_Buff[0] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[1] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[2] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[3] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[4] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[5] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[6] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[7] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[8] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[9] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[10] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[11] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[12] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[13] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[14] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[15] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[16] = Mcu_Time1s_Cnt&0x0F;
                                I2CA_TX_Buff[17] = Mcu_Time1s_Cnt&0x0F;
                            }
                            else
                            {
            ...
            {   // Read S5;
                ...
                if (g_iica0_rx_cnt < g_iica0_rx_len)
                {
                    *gp_iica0_rx_address = IICA->IICA0;
                    ...
                    if(g_iica0_rx_cnt == 1)
                    {
                        Usr_Md_Cmd0 = gp_iica0_rx_address[-1];
                        
                    }
                    else if(g_iica0_rx_cnt == 2)
                    {
                        Usr_Md_Cmd1 = gp_iica0_rx_address[-2];
