    ...
    {   
        ...
        else if((usAddress>=1536)&&(usAddress<1536+128))
        {
            ...
            {   
                ...
                {
                    *(pucRegBuffer+i*2) = DF_Data[usAddress-1536 + i*2+1]>>8;
                    *(pucRegBuffer+i*2+1) = DF_Data[usAddress-1536 + i*2];
                }
            }
        }
        else
        ...
        else if((usAddress>=1536)&&(usAddress<1536+128))
        {
            ...
            {   
                if(usAddress+i<=1536+128)
                {
                    ...
                    DF_Data[pucRegBuffer+i-1536+0] = (uint8_t)val;
                    DF_Data[pucRegBuffer+i-1536+1] = (uint8_t)(val>>8);
                    
                    DF_UpdataReal_Flag = 1;
                }
            }
        }
        else
