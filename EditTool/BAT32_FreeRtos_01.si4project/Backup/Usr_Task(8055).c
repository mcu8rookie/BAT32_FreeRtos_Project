...
{   
    ...
    while(1)
    {
        ...
        if(QueuePtr_Task1_To_Task2 != NULL)
        {
            ...
            RtnCode = xQueueSend(QueuePtr_Task1_To_Task2,buff,1000);
...
{   
    ...
    while(1)
    {
        ...
        if(QueuePtr_Task2_To_Task3 != NULL)
        {
            ...
            RtnCode = xQueueSend(QueuePtr_Task2_To_Task3,buff,1000);
            if(RtnCode == pdPASS)
            {
...
{   
    ...
    while(1)
    {
        ...
        if(QueuePtr_Task3_To_Task4 != NULL)
        {
            ...
            RtnCode = xQueueSend(QueuePtr_Task3_To_Task4,buff,1000);
            if(RtnCode == pdPASS)
            {
...
{   
    ...
    while(1)
    {
        ...
        if(QueuePtr_Task4_To_Task5 != NULL)
        {
            ...
            RtnCode = xQueueSend(QueuePtr_Task4_To_Task5,buff,1000);
            if(RtnCode == pdPASS)
            {
