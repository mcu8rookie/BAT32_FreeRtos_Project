...
{   
    ...
    {   // Master Write completely;
        ...
        Init_printf("\ng_iica0_slave_status_flag, %d, g_iica0_tx_end, %d, g_iica0_tx_cnt, %d, ",g_iica0_slave_status_flag,g_iica0_tx_end,g_iica0_tx_cnt);
    ...
    {   // Mater Read completely; (ReStart;)
        ...
        g_iica0_slave_status_flag = 0;  /* iica0 slave flag */
        gp_iica0_tx_address = I2CA_RX_Buff;        /* iica0 send buffer address */
