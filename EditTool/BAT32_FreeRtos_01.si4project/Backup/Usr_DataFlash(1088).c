...
void Usr_DFData_To_Variable(void)
{
    ...
    #if(defined(DEF_ASC_EN)&&(DEF_ASC_EN==1))
    {
        ...
        ASC_Tmpr_RateTh = DF_Data[DEF_ASC_TMPR_THRE_INDEX+1];
        ASC_Tmpr_RateTh <<= 8;
        ASC_Tmpr_RateTh += DF_Data[DEF_ASC_TMPR_THRE_INDEX];
        
        ASC_Humi_RateTh = DF_Data[DEF_ASC_HUMI_THRE_INDEX+1];
        ASC_Humi_RateTh <<= 8;
        ASC_Humi_RateTh += DF_Data[DEF_ASC_HUMI_THRE_INDEX];
