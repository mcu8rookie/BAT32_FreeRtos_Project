        ...
        {   // Write Debug Information area;
            ...
            {   
                ...
                {   // Write ASC_Tmpr_RateTh;
                    ...
                    DF_Data[DEF_ASC_TMPR_THRE_INDEX] = (uint8_t)val;
                    DF_Data[DEF_ASC_TMPR_THRE_INDEX+1] = (uint8_t)(val>>8);
                ...
                {   // Write ASC_Humi_RateTh;
                    ...
                    DF_Data[DEF_ASC_HUMI_THRE_INDEX] = (uint8_t)val;
                    DF_Data[DEF_ASC_HUMI_THRE_INDEX+1] = (uint8_t)(val>>8);
