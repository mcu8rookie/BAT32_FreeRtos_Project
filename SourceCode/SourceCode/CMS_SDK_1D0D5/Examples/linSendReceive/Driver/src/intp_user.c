...
/***********************************************************************************************************************
* Function Name: intp_0_6_interrupt
...
/***********************************************************************************************************************
* Function Name: intp_1_7_interrupt
* @brief  INTP1 or INTP7 interrupt entry
* @param  None
* @return None
***********************************************************************************************************************/
void intp_1_7_interrupt(void)
{
    volatile uint8_t ifl, ifh;
...
/***********************************************************************************************************************
* Function Name: intp_2_8_interrupt
* @brief  INTP2 or INTP8 interrupt entry
* @param  None
* @return None
***********************************************************************************************************************/
void intp_2_8_interrupt(void)
{
    volatile uint8_t ifl, ifh;

    ifl = INTC_GetPendingIRQ(INTP2_IRQn);
    ifh = INTC_GetPendingIRQ(INTP8_IRQn);
...
/***********************************************************************************************************************
* Function Name: intp_3_9_interrupt
* @brief  INTP3 or INTP9 interrupt entry
* @param  None
* @return None
***********************************************************************************************************************/
void intp_3_9_interrupt(void)
{
    volatile uint8_t ifl, ifh;

    ifl = INTC_GetPendingIRQ(INTP3_IRQn);
    ifh = INTC_GetPendingIRQ(INTP9_IRQn);
...
/***********************************************************************************************************************
* Function Name: intp_4_10_interrupt
* @brief  INTP4 or INTP10 interrupt entry
* @param  None
* @return None
***********************************************************************************************************************/
void intp_4_10_interrupt(void)
{
    volatile uint8_t ifl, ifh;

    ifl = INTC_GetPendingIRQ(INTP4_IRQn);
    ifh = INTC_GetPendingIRQ(INTP10_IRQn);
...
/***********************************************************************************************************************
* Function Name: intp_5_11_interrupt
* @brief  INTP5 or INTP11 interrupt entry
* @param  None
* @return None
***********************************************************************************************************************/
void intp_5_11_interrupt(void)
{
    volatile uint8_t ifl, ifh;

    ifl = INTC_GetPendingIRQ(INTP5_IRQn);
    ifh = INTC_GetPendingIRQ(INTP11_IRQn);
