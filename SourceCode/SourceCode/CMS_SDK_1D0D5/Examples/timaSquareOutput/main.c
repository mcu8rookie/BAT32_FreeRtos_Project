...
//-----------------------------------------------------------------------
// No.61 pin(P01/TAIO) output square wave
//-----------------------------------------------------------------------
	g_tma0_underflow_count = 0;
	TMA0_SquareOutput(TMA_COUNT_SOURCE_FCLK, 200);
	while(g_tma0_underflow_count < 100);

	g_tma0_underflow_count = 0;
	TMA0_SquareOutput(TMA_COUNT_SOURCE_FIL, 2);
	while(g_tma0_underflow_count < 100);
