    ...
    {   
        ...
        {   // Read Debug informastion area;
            ...
            {   
                ...
                {   // Read TComp_TRawBase;
                    *(pucRegBuffer+i*2) = g_TCompCoeff.baseTRaw >> 8;
                    *(pucRegBuffer+i*2+1) = g_TCompCoeff.baseTRaw;
                }
                else if(usAddress+i==831)
                {   // Read Tcomp_Coe0 L16bit;
                    ptr1 = (uint8_t*)(&g_TCompCoeff.P0);
                ...
                {   // Read Tcomp_Flag;
                    *(pucRegBuffer+i*2) = 0;
                    *(pucRegBuffer+i*2+1) = g_TCompCoeff.flag;
                }
                ...
                else if(usAddress+i == 885)
                {   // Read HeatBoard_PreTime;
                    *(pucRegBuffer+i*2) = HeatBoard_PreTime>>8;
                    *(pucRegBuffer+i*2+1) = HeatBoard_PreTime;
                }
                #endif
        ...
        {   // Write Debug Information area;
            ...
            {   
                ...
                {   // Write TComp_P0;
					...
					pTemp = (uint16_t*)&g_TCompCoeff.P0;
					pTemp[0] = val;
                ...
                {   // Write TComp_P1;
					...
					pTemp = (uint16_t*)&g_TCompCoeff.P1;
					pTemp[0] = val;
                ...
                {   // Write TComp_P2 Low D16b;
					...
					pTemp = (uint16_t*)&g_TCompCoeff.P2;
					pTemp[0] = val;
                ...
                {   // Write TComp_P3 Low D16b;
					...
					pTemp = (uint16_t*)&g_TCompCoeff.P3;
					pTemp[0] = val;
