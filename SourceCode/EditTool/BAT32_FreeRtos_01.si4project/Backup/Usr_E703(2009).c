...
void Usr_Read_All_Reg(void)
{
    ...
    for(i=0;i<DEF_REG_DATA_NUM;i++)
    {
        E703_RegBuff[i] = (uint8_t)E703_CMData_Probe[i].data;
    }
    #endif
}
...
{   
    ...
    E703_RegData[17].data = E703_ADC_TC;
    E703_RegData[18].data = E703_ADC_T;
    E703_RegData[19].data = E703_ADC_S;
    E703_RegData[21].data = E703_DSP_T;
    E703_RegData[22].data = E703_DSP_S;
