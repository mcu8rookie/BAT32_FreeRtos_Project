...
void Usr_I2C20_MainLoop(void)
{
    ...
    g_iic00_tx_end = 0;
    IIC00_MasterSend(DEF_HDC3020_I2C_ADD_WT, i2c00_wtbuf, 2);
    while(g_iic00_tx_end == 0);
    
    g_iic00_rx_end = 0;
    IIC00_MasterReceive(DEF_E703_I2C_ADDR_WT, i2c00_rdbuf, 3);
    while(g_iic00_rx_end == 0);
    
    Debug_printf_Mut("\nHDC3020_ID: 0x%02X,0x%02X,0x%02X,",i2c00_rdbuf[0],i2c00_rdbuf[1],i2c00_rdbuf[2]);
    #endif
}
