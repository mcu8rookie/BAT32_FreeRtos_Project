...
//-----------------------------------------------------------------------
// Measure the pulse width of No.33 pin(P50/TBIO0) and No.34 pin(P51/TBIO1)
//-----------------------------------------------------------------------
	width = TMB0_Get_PulseWidth(TMB_CLOCK_FCLK, TMB_CHANNELA);
	printf("P50/TBIO0 pulse width  = %d fCLK\n", width);  /* expected value: msCnt */
	//width = TMB0_Get_PulseWidth(TMB_CLOCK_FCLK, TMB_CHANNELB);
	//printf("P51/TBIO1 pulse width  = %d fCLK\n", width);  /* expected value: msCnt */
	
//-----------------------------------------------------------------------
// Measure the pulse period of No.33 pin(P50/TBIO0) and No.34 pin(P51/TBIO1)
//-----------------------------------------------------------------------
  period = TMB0_Get_PulsePeriod(TMB_CLOCK_FCLK, TMB_CHANNELA);
	printf("P50/TBIO0 pulse period = %d fCLK\n", period);  /* expected value: msCnt * 2 */
  //period = TMB0_Get_PulsePeriod(TMB_CLOCK_FCLK, TMB_CHANNELB);
	//printf("P51/TBIO1 pulse period = %d fCLK\n", period);  /* expected value: msCnt * 2 */	
}
...
{
	PORT->PM5 &= ~(1 << 0);  /* P50/TBIO0 output mode */
	PORT->P5  ^=  (1 << 0);  /* P50/TBIO0 toggle */
	g_ticks--;
}
