...
//-----------------------------------------------------------------------
#ifndef RTL_SIMULATION
	printf("Please connect No.58 pin(P04/SCK10) to No.46 pin(P10/SCK11)\n");
	printf("Please connect No.60 pin(P02/SDO10) to No.45 pin(P11/SDI11)\n");
	printf("Please connect No.59 pin(P03/SDI10) to No.44 pin(P12/SDO11)\n");
