...
//-----------------------------------------------------------------------
// Configure Option Byte C0H to enable WDT in system_BAT32A237.c
//-----------------------------------------------------------------------
	for(i=0; i<8; i++)
	{	
		__HALT();  	/* Sleep */
		printf("Wake up from sleep by WDT interrupt: No.%02d\n", g_WdtIntTaken);
	}	
 	
	for(i=0; i<8; i++)
	{	
		__STOP();  	/* Deep Sleep */
		printf("Wake up from deep sleep by WDT interrupt: No.%02d\n", g_WdtIntTaken);
	}	
